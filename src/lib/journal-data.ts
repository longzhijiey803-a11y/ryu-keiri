...
export const JOURNAL_ENTRIES: JournalEntry[] = [
  ...
  mk({
    ...
    description: "セミナー参加費（要確認 / AI候補）",
    status: "ai_predicted",
    related_transaction_id: null,
    related_transaction_name: null,
    attachments: [
      { id: "JA-AI1", file_name: "領収書_seminar.pdf", mime_type: "application/pdf", size_bytes: 71_000, uploaded_at: "2026-05-18T19:00:00+09:00", uploaded_by: "AI 取込" },
    ],
    memo: "OCR + AIで自動仕訳候補を生成しました。勘定科目を確認してください。",
    created_by: U.u1,
    created_at: "2026-05-18T19:01:00+09:00",
    updated_at: "2026-05-18T19:01:00+09:00",
    lines: [
      { side: "debit", account_code: "7400", sub_account: null, amount: 30_000, tax_category: T10, tax_amount: 3_000, department: "開発部", project: "自社プロダクト", ai_predicted: true },
      { side: "debit", account_code: "1360", sub_account: null, amount: 3_000, tax_category: NT, tax_amount: 0, department: "開発部", project: "自社プロダクト" },
      { side: "credit", account_code: "1100", sub_account: "本店", amount: 33_000, tax_category: NT, tax_amount: 0, department: "開発部", project: "自社プロダクト" },
    ],
  }),
  mk({
    id: "JV-1211",
    entry_date: "2026-05-18",
    description: "クラウドサービス利用料（AI 候補）",
    status: "ai_predicted",
    related_transaction_id: null,
    related_transaction_name: null,
    attachments: [
      { id: "JA-AI2", file_name: "請求書_cloud_202605.pdf", mime_type: "application/pdf", size_bytes: 73_400, uploaded_at: "2026-05-18T11:00:00+09:00", uploaded_by: "AI 取込" },
    ],
    memo: "摘要キーワードから勘定科目を推測。",
    created_by: U.u1,
    created_at: "2026-05-18T11:01:00+09:00",
    updated_at: "2026-05-18T11:01:00+09:00",
    lines: [
      { side: "debit", account_code: "7300", sub_account: null, amount: 60_000, tax_category: T10, tax_amount: 6_000, department: "開発部", project: "自社プロダクト", ai_predicted: true },
      { side: "debit", account_code: "1360", sub_account: null, amount: 6_000, tax_category: NT, tax_amount: 0, department: "開発部", project: "自社プロダクト" },
      { side: "credit", account_code: "2100", sub_account: "取引先別", amount: 66_000, tax_category: NT, tax_amount: 0, department: "開発部", project: "自社プロダクト", ai_predicted: true },
    ],
  }),
  mk({
    id: "JV-1212",
    entry_date: "2026-05-19",
    description: "コンビニ会計（飲料・茶菓 / AI候補）",
    status: "ai_predicted",
    related_transaction_id: null,
    related_transaction_name: null,
    attachments: [],
    memo: "明確なキーワードなし。雑費として仮置き。",
    created_by: U.u1,
    created_at: "2026-05-19T08:00:00+09:00",
    updated_at: "2026-05-19T08:00:00+09:00",
    lines: [
      { side: "debit", account_code: "7900", sub_account: null, amount: 1_800, tax_category: T10, tax_amount: 180, department: "営業部", project: "コーポレート", ai_predicted: true },
      { side: "debit", account_code: "1360", sub_account: null, amount: 180, tax_category: NT, tax_amount: 0, department: "営業部", project: "コーポレート" },
      { side: "credit", account_code: "1100", sub_account: "本店", amount: 1_980, tax_category: NT, tax_amount: 0, department: "営業部", project: "コーポレート" },
    ],
  }),
  mk({
    id: "JV-1031",
